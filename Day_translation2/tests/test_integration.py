...
from Day_translation2.models.result_models import OperationResult, OperationStatus
...
class TestIntegration:
    ...
    def test_models_import(self):
        """测试模型类导入"""
        from Day_translation2.models.exceptions import (
            TranslationError, ConfigError, ImportError, ProcessingError
        )
        from Day_translation2.models.result_models import (
            OperationResult, OperationStatus, OperationType
        )
    ...
    def test_services_import(self):
        """测试服务模块导入"""
        from Day_translation2.services.batch_processor import BatchProcessor
        from Day_translation2.services.machine_translate import MachineTranslateService
        from Day_translation2.services.corpus_generator import generate_parallel_corpus
    ...
    def test_utils_import(self):
        ...
        from Day_translation2.utils.filters import ContentFilter
