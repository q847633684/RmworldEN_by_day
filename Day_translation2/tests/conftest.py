...
def assert_operation_success(result: OperationResult, expected_message: Optional[str] = None):
    """断言操作成功"""
...
def assert_operation_error(result: OperationResult, expected_error: Optional[str] = None):
    """断言操作失败"""
