...
from ..models.exceptions import TranslationError, ConfigError, ImportError as TranslationImportError
...
class TranslationFacade:
    ...
    def export_with_advanced_features(self, 
                                     translations: List = None,
                                     output_dir: str = None,
                                     export_config: Optional[Dict[str, Any]] = None) -> OperationResult:
        """
        使用高级功能导出翻译
        ...
        try:
            ...
            logging.error(error_msg)
            raise TranslationError(error_msg, context={
                "mod_dir": self.mod_dir,
                "language": self.language,
                "output_dir": output_dir,
    ...
    def export_with_smart_merge(self, 
                               translations: List = None,
                               output_dir: str = None,
                               mode: str = "smart-merge",
                               auto_mode: bool = False) -> OperationResult:
        """
        使用智能合并模式导出翻译
    ...
    def export_with_user_interaction(self, 
                                   translations: List = None,
                                   output_dir: str = None) -> OperationResult:
        """
        使用用户交互模式导出翻译
    ...
    def process_with_workflow_automation(self, 
                                       workflow_config: Dict[str, Any]) -> OperationResult:
        """
        使用工作流自动化处理翻译
