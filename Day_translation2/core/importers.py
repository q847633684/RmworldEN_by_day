    ...
    try:
        ...
        with open(csv_path, 'r', encoding='utf-8') as csvfile:
            ...
            if not all(col in reader.fieldnames for col in required_columns):
                ...
                column_mapping = {
                    'key': ['key', 'Key', 'ID', 'id'],
                    'target_text': ['target_text', 'translated_text', 'translation', 'chinese', '中文']
                }
...
def import_translation_entries(
    ...
    language = entries[0].context_info.get("language", CONFIG.core.default_language) if entries else CONFIG.core.default_language
