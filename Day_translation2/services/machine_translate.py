...
def translate_csv(input_csv: str, output_csv: str, access_key: str, secret_key: str,
                 source_language: str = "en", target_language: str = "zh") -> OperationResult:
    """
    翻译CSV文件中的文本内容
    ...
    try:
        ...
        # 执行翻译
        translated_data = _translate_data(translator, translations, source_language, target_language)
...
def _translate_data(translator, data: List[Dict[str, str]], 
