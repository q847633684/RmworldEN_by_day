...
def test_advanced_filter_rules():
    ...
    try:
        ...
        # 测试基本过滤功能
        should_translate = filter_rules.should_translate_keyed("Hello World", "TestKey")
        print(f"✅ 高级过滤规则测试成功: should_translate={should_translate}")
        return True

    except Exception as e:
        print(f"❌ 高级过滤规则测试失败: {e}")
        return False
...
def main():
    ...
    tests = [
        ...
        ("高级过滤规则", test_advanced_filter_rules),
    ]
