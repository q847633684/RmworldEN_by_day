...
class UserInteractionManager:
    ...
    def handle_existing_translations_choice(self, 
                                          output_dir_path: str, 
                                          file_pattern: str = "*.xml",
                                          backup_enabled: bool = True,
                                          auto_mode: Optional[str] = None,
                                          enable_advanced_options: bool = False) -> ExportMode:
        """
        处理现有翻译文件的用户选择
    ...
    def _handle_auto_mode(self, auto_mode: str, existing_files: List[Path], output_dir_path: str) -> ExportMode:
        """处理自动模式"""
        mode_map = {
    ...
    def _display_processing_options(self, backup_enabled: bool = True, enable_advanced_options: bool = False) -> Dict[str, ExportMode]:
        """显示处理选项"""
        if self.enable_colors:
        ...
        option_count = 4
        choice_map = {
            "1": ExportMode.REPLACE,
            "2": ExportMode.MERGE,
            "3": ExportMode.SMART_MERGE
        }
    ...
    def _execute_choice(self, mode: ExportMode, existing_files: List[Path], output_dir_path: str) -> ExportMode:
        """执行用户选择的操作"""
    ...
    def _execute_incremental_mode(self, existing_files: List[Path], output_dir_path: str) -> List[Path]:
        """执行增量更新模式"""
    ...
    def _generate_preview(self, existing_files: List[Path], output_dir_path: str) -> FileAnalysisResult:
        """生成预览信息"""
...
# 兼容性函数，支持旧代码调用
def handle_existing_translations_choice(output_dir_path: str, 
                                      file_pattern: str = "*.xml",
                                      backup_enabled: bool = True,
                                      auto_mode: Optional[str] = None,
