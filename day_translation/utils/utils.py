...
class XMLProcessor:
    ...
    def get_element_by_attr(
        self, tree: Any, attr_name: str, attr_value: str, exact: bool = True
    ) -> List[Any]:
        """
        通过属性获取元素
    ...
    def get_element_by_text(
        self, tree: Any, text: str, exact: bool = True
    ) -> List[Any]:
        """
        通过文本内容获取元素
...
def save_xml_to_file(
    tree: Any, file_path: str, use_lxml: bool = LXML_AVAILABLE
) -> bool:
    """兼容旧版保存 XML 文件"""
